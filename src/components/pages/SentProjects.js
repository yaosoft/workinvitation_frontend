                        ...
                        <div className="card">
                            <div className="card-body">
                                <div className="email-left-box">
                                    ...
                                    <div className="mail-list mt-4"><a href="#" className="list-group-item border-0 p-r-0"><i className="fa fa-plane font-18 align-middle mr-2"></i>Posted projects <span className="badge badge-warning badge-sm float-right m-t-5">47</span> </a>
									<a href="#" className="list-group-item border-0 p-r-0"><i className="fa fa-envelope font-18 align-middle mr-2"></i>Sent invitations <span className="badge badge-danger badge-sm float-right m-t-5">47</span> </a>
									<a href="email-inbox.html" className="list-group-item border-0 text-primary p-r-0"><i className="fa fa-inbox font-18 align-middle mr-2"></i> Viewed <span className="badge badge-primary badge-sm float-right m-t-5">19</span> </a>
